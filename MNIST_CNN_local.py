...
def run(f):
    ...
    filename1 = "./log/cnn/unif/10_committee_samemodel/7_bz128_0.01/loss/" + "loss.txt"
    filename2 = "./log/cnn/unif/10_committee_samemodel/7_bz128_0.01/error/" + "Test_error.txt"
