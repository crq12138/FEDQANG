...
class Client():
    def __init__(self, dataset, filename, batch_size, model,port,train_cut=.80, credit_score=100.0, quality_score=100.0, p2p_node=None):
        ...
        self.trainset = Dataset(filename, "./cifar-10-batches-py/cifar10", is_train=True, transform=transform)
        self.testset = Dataset("cifar10_test", "./cifar-10-batches-py/cifar10", is_train=False, transform=transform)
