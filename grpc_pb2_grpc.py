...
class GameStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.Gamesend = channel.unary_unary(
                '/Game/Gamesend',
                request_serializer=grpc__pb2.Gamemessage.SerializeToString,
                response_deserializer=grpc__pb2.MsgReceive.FromString,
                _registered_method=True)
...
def add_GameServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Gamesend': grpc.unary_unary_rpc_method_handler(
                    servicer.Gamesend,
                    request_deserializer=grpc__pb2.Gamemessage.FromString,
                    response_serializer=grpc__pb2.MsgReceive.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class Game(object):
    ...
    def Gamesend(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Game/Gamesend',
            grpc__pb2.Gamemessage.SerializeToString,
            grpc__pb2.MsgReceive.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
