...
for client_id in client_ids:
    # 设置日志文件路径
    # loss_log_path = f'./log/cnn/unif/10/loss/loss_{client_id}.txt'
    # error_log_path = f'./log/cnn/unif/10/error/Test_error_{client_id}.txt'
    # time_log_path = f'./log/cnn/unif/10/time/time_correspond{client_id}.txt'
...
plot_multiple_clients(
    ...
    'Iteration',
    'Loss',
    save_path='./result/cnn/unif_with_comm/loss_plot.png'
)
...
plot_multiple_clients(
    ...
    'Iteration',
    'Error',
    save_path='./result/cnn/unif_with_comm/error_plot.png'
)
...
plot_multiple_clients(
    ...
    'Iteration',
    'Time (s)',
    save_path='./result/cnn/unif_with_comm/time_plot.png'
)
...
plot_average(
    ...
    'Iteration',
    'Loss',
    save_path='./result/cnn/unif_with_comm/average_loss_plot.png'
)
...
plot_average(
    ...
    'Iteration',
    'Error',
    save_path='./result/cnn/unif_with_comm/average_error_plot.png'
)
...
plot_average(
    ...
    'Iteration',
    'Time (s)',
    save_path='./result/cnn/unif_with_comm/average_time_plot.png'
)
